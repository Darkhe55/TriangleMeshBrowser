...
public:
    ...
    void drawPoints() const;     // 点云 (GL_POINTS)
    ...
    std::uint32_t pointCount() const noexcept { return pointCount_; }
    bool   hasWireframe() const noexcept { return lineEbo_ != 0; }
    bool   hasPoints() const noexcept { return pointVao_ != 0; }
    bool   hasPointColors() const noexcept { return pointHasColor_; }
